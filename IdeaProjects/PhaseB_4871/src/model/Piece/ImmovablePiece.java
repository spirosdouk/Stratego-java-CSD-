...
/**
 * ImmovablePiece Class extends Piece
 */
public class ImmovablePiece implements Piece
{
    ...
    private String name;
     ...
     /**
     * <br>Constructor
     * <br>Precondition: rank value should to be between 0 and 10, name should be String and name!=""
     * super method sets rank=rank ,name=name,x=x,y=y its coordinates
     * @param rank Rank of piece
     * @param name Name of piece
     */
    public ImmovablePiece(int rank, String name)
    {
        setName(name);
        setRank(rank);
    }
